...
public interface HCollection 
{
    ...
    */
    ...
    /**
      ...
      * @return {@code true} true if this collection contains all of the elements in the specified collection 
     ...
     * must exercise care if they choose to override the Object.equals. It is not necessary to do so,
     * and the simplest course of action is to rely on Object's implementation, but the implementer
     * may wish to implement a "value comparison" in place of the default "reference comparison." 
     ...
     * (in other words, a.equals(b) if and only if b.equals(a)).
     ...
     *  programmers should take note that any class that overrides the Object.equals method
     *  must also override the Object.hashCode method in order to satisfy the general
     *  contract for the Object.hashCodemethod. In particular, c1.equals(c2) implies that
     ...
     *  e such that (o==null ? e==null : o.equals(e)), if this collection contains
     *  one or more such elements. Returns true if this collection contained the specified element
...
/**
     ...
     *  returned array is that of the specified array. If the collection fits in the specified array, it is returned therein. Otherwise, a new array is allocated with the runtime type of the specified array and the size of this collection.
