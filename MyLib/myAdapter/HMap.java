...
public interface HMap
{
     ...
     * returns true if and only if this map contains at a mapping for a key k such that 
    ...
    public static interface Entry
    {
        ...
        * @return {@code true} if the specified object is equal to this map entry.
         ...
         *  for any two Entries e1 and e2, as required by the general contract of Object.hashCode. 
         * @return the hash code value for this map entry.s
         */
        int hashCode();

        /**
         * Replaces the value corresponding to this entry with the specified value (optional operation).
         *  (Writes through to the map.) The behavior of this call is undefined if the mapping has already been removed
