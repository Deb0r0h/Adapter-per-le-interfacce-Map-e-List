...
public interface HSet extends HCollection
{
     ...
     *  More formally, adds the specified element, o, to this set if this set contains no element e such that
     *  (o==null ? e==null : o.equals(e)). If this set already contains the specified element,
     *  the call leaves this set unchanged and returns false. In combination with the restriction on constructors,
     ...
     *  sets may refuse to add any particular element, including null, and throwing an exception, as described in the specification for Collection.add. 
     ...
     * set so that its value is the union of the two sets. The behavior of this operation is 
     * unspecified if the specified collection is modified while the operation is in progress. 
    ...
    /**
     * Removes all of the elements from this set (optional operation).ù
     ...
     *  This ensures that s1.equals(s2) implies that s1.hashCode()==s2.hashCode() for any two sets s1 and s2, as required by the general
     ...
     * @return {@code true} true if this set contains no elements.
     */
    boolean isEmpty();
